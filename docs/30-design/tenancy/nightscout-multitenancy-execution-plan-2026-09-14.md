...
- **Phase 0, `cgm-remote-monitor` half: merged, not released.** T0.1 (#8733), T0.2/T0.3
  ...
  `bf/connect-pin`; connector PR #68 (T0.4) is open.
...
`c1cce2a`; connector PR #68, open** (queue `P0-F`). Based on `b77e5bb` (the commit
`chore/nightscout-modernization` pins). 19 new tests, suite **135 pass / 0 fail**, every part of the
change reverted in turn and caught by at least one test. Harness `tools/mt-bench/vcherd.js`
