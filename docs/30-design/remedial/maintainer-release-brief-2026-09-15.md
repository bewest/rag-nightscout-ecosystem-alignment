...
Semver classification is from the versioning analysis (GT4, `docs/60-research/modernization/gt4-semver-classification-2026-09-15.md`).
...
| **Evidence** | `docs/30-design/remedial/nightscout-backfix-register.md` BF-28/BF-29/BF-31; commit messages carry their own before/after measurements |
...
| **Evidence** | register BF-06/BF-07; `docs/60-research/remedial/t02-t03-cache-clone-2026-09-15.md` |
...
| **Evidence** | register BF-34, BF-08; `docs/60-research/modernization/gt4-semver-classification-2026-09-15.md` §6 |
...
— `docs/60-research/modernization/gt4-semver-classification-2026-09-15.md` — and the 3 s → 67 s figure is T0.4's
