...
| ref | document |
|---|---|
| **{P}** | [Multitenancy execution plan](../30-design/nightscout-multitenancy-execution-plan-2026-09-14.md) — T2.3 |
| **{S}** | [T1.1 — the storage seam](../30-design/nightscout-storage-seam-interface-2026-09-14.md) — §8.5, §10.5 |
