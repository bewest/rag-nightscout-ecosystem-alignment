...
| register | `docs/30-design/nightscout-backfix-register.md`, 69 entries (67 `BF-`, `CAP-01`, `CAP-02`) |
...
|---|---|
| [`nightscout-backfix-register.md`](../30-design/nightscout-backfix-register.md) | authoritative for **defect facts and ids**. This document never allocates one (rule 4) |
...
| [`workflow-completeness-critique-2026-09-15.md`](workflow-completeness-critique-2026-09-15.md) | §C is the finding this work answers, and §1 above records where its framing needed correcting |
| [`phase0-pr-sequencing-2026-09-15.md`](../30-design/phase0-pr-sequencing-2026-09-15.md) | §5 is the ten follow-ups; §5.4 and §5.5 above correct two of them |
