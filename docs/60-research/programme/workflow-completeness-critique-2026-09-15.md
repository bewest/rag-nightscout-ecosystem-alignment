...
| 7 | Semver classification + policy | `docs/30-design/modernization/semver-and-release-versioning-policy-2026-09-15.md` (1618 L) + `tools/qc/semver-surface-gate.js` | **Met, with a runnable gate** |
...
docs/30-design/remedial/nightscout-backfix-register.md    19:57
