...
| file | mtime | by |
|---|---|---|
| `docs/30-design/phase0-pr-sequencing-2026-09-15.md` | **17:06** | `8c379476` — added branches G/H/I |
| `docs/30-design/nightscout-backfix-register.md` | **17:04** | `9fc55eaa` — BF-35…BF-38 |
| `docs/30-design/nightscout-multitenancy-execution-plan-2026-09-14.md` | 16:42 | `4382d8f8` |
| `docs/60-research/multitenancy-k-and-residency-2026-09-14.md` | 15:19 | |
