...
|---|---|---:|---:|---:|
| **Remedial** | `phase0`, `register-open`, `docs-truth` | 87 | 32 | 12 |
| **Modernization** | `release-train` | 21 | 3 | 3 |
...
| `BFQ-111` | `not-started` | BF-111 - find[_id][$in] misses records stored with a string _id, for reads and bulk delete |
| `BFQ-112` | `not-started` | BF-112 - an auth subject created with a hex _id is stored as a string and cannot be delete |
...
| `release-train` | 3 |  | 4 | 1 | 5 | 1 | 5 | 1 |  |  |  | 1 | **21** |
| `register-open` | 22 | 1 | 5 |  | 4 | 2 | 13 | 5 |  | 2 | 1 |  | **55** |
