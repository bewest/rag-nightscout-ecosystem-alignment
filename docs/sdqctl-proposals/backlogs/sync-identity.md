...
|---|------|----------|--------|-------|
| 1 | Trace REQ-031 through REQ-035 | P2 | Low | 5 uncovered sync requirements |
| 2 | Impact analysis: Duration unit standardization | P2 | Medium | OQ-030 - all 4 alternatives |
| 3 | Impact analysis: utcOffset unit | P2 | Low | OQ-031 - combine with duration |
