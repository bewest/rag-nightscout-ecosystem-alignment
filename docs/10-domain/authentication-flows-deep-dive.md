...
| File | Purpose |
|------|---------|
| `cgm-remote-monitor-official:lib/authorization/index.js` | Main authorization logic |
| `cgm-remote-monitor-official:lib/authorization/storage.js` | Subject/role storage |
| `cgm-remote-monitor-official:lib/authorization/endpoints.js` | REST endpoints |
| `cgm-remote-monitor-official:lib/authorization/delaylist.js` | Rate limiting |
| `cgm-remote-monitor-official:lib/server/enclave.js` | Secret hashing, JWT signing |
