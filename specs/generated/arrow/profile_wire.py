...
PROFILE_WIRE_SCHEMA = pa.schema([
    ...
    pa.field("enteredBy", pa.large_string(), metadata={"sensitivity": "identifying", "category": "identity"}),  # 99% docs, 10 sites; core
    ...
    ]), metadata={"sensitivity": "descriptive", "category": "vocabulary"}),  # 99% docs, 10 sites; core
    pa.field("mills", pa.large_string(), metadata={"sensitivity": "quasi-identifying", "category": "temporal"}),  # 100% docs, 11 sites; universal; union of integer, string widened to string
    pa.field("srvCreated", pa.int64(), metadata={"sensitivity": "identifying", "category": "temporal"}),
    pa.field("srvModified", pa.int64(), metadata={"sensitivity": "quasi-identifying", "category": "temporal"}),  # 1% docs, 1 sites; rare
    pa.field("startDate", pa.large_string(), metadata={"sensitivity": "quasi-identifying", "category": "temporal"}),  # 100% docs, 11 sites; universal
    pa.field("store", pa.map_(pa.large_string(), pa.struct([
        ...
        ])), metadata={"sensitivity": "descriptive", "category": "vocabulary"}),  # 100% docs, 11 sites; universal
    pa.field("units", pa.large_string(), metadata={"sensitivity": "descriptive", "category": "vocabulary"}),  # 100% docs, 11 sites; universal
    pa.field("utcOffset", pa.int64(), metadata={"sensitivity": "identifying", "category": "location"}),
])
