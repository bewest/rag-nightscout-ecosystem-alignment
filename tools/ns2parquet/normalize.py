...
def _extract_oref0_ds(ds: dict) -> dict:
    ...
    return {
        ...
        # meal-dosing safety), NOT 'bolusiob'. True bolus IOB = iob - basaliob.
        # The PK bridge provides a correct decomposition from first principles.
        'bolussnooze': float(iob_data.get('bolussnooze', 0)) if 'bolussnooze' in iob_data else None,
