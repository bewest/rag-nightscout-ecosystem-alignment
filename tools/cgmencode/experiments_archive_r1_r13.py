"""
experiments_archive_r1_r13.py — Archived experiments from Rounds 1-13.

These experiment functions (EXP-026 through EXP-109) have been run and
their results committed. They are preserved here for reference and
reproducibility but are NOT actively maintained.

Results are in externals/experiments/exp026-exp109*.json
"""

import json as _json_mod

# Re-export for any archive experiment that needs it
...
# Needed by backtest experiments
import os
