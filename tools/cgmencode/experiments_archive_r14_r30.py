"""
experiments_archive_r14_r30.py — Archived experiments EXP-110 through EXP-238.

These experiments were run across Rounds 14-30 of the cgmencode experiment
campaign. Results are saved in externals/experiments/exp110-exp238*.json.

Historical note: Experiments before EXP-159 used a pipeline with a future
action leak (IOB, COB, bolus, carbs visible in forecast window). Results
from those experiments are inflated. See gen3-transition-report.md.

Experiments EXP-159+ use proper future masking via FUTURE_UNKNOWN_CHANNELS.

To re-run an archived experiment:
    from .experiments_archive_r14_r30 import ARCHIVE_REGISTRY
    # Then register selectively in experiments_agentic.py
"""
