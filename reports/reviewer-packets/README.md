...
| [`RT-COUNT-COMPAT`](rt-count-compat-bf-count-client-compat.md) | &mdash; | `in-flight-upstream` | Reads accept the count shapes oref0 and GluPredKit send; 15.0.9 stays a patch |
...
*Generated by `tools/queue/emit_packets.py` (`make packets`) from `queue/work-queue.yaml`, `measured_at` 2026-09-23.*
