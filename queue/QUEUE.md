...
| `ready-to-push` | 11 | P0-C-REMEDIATE, T30-AUTH, BFQ-69, BFQ-47, BFQ-90, BFQ-97, BFQ-98, BFQ-99, BFQ-100, BFQ-101, BFQ-102 |
...
| `BFQ-97` | BF-97 - on the connector 0.1.0 line, a source with a profile stalls every poll | `ready-to-push` | `fix/profile-sync-bounded-update` | patch | 0 run + 1 no-gate |
