...
| `ready-to-push` | 3 | P0-C-REMEDIATE, RT-COUNT-COMPAT, T30-AUTH |
...
| `RT-COUNT-COMPAT` | Reads accept the count shapes oref0 and GluPredKit send; 15.0.9 stays a patch | `ready-to-push` | `bf/count-client-compat` | patch | 0 run + 1 no-gate |
